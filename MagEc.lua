...
--
-- below line: revised from 1 to 0 by boyangliu 20190305. number must be in INTERGER
if ( TestBeepNoShutter == 0 )
then
	-- La Silla (UTC-4): 15:23:51.1 16:39:24.3 16:41:15.6 17:47:16.7
	c1.hr = 15; c1.min = 23; c1.sec = 51;
	c2.hr = 16; c2.min = 39; c2.sec = 24;
	c3.hr = 16; c3.min = 41; c3.sec = 16;
	c4.hr = 17; c4.min = 47; c4.sec = 17;
else
	-- Testing:
	c1.hr = 0; c1.min =  0; c1.sec = 10;
	c2.hr = 0; c2.min =  1; c2.sec = 10;
	c3.hr = 0; c3.min =  3; c3.sec = 1;
	c4.hr = 0; c4.min =  4; c4.sec = 1;
end
...
--
DoShutterShockDelay = 0
SlowestDelayedShutter = 2
FastestDelayedShutter = (1/125)
ShutterShockDelayMS = 500		-- Value is in milliseconds!
...
PartialExposureCount = 5		-- Number of partial phase exposures before and after totality
PartialDoBkt = 0				-- Do you want to do exposure bracketing?  1 - yes, 0 - no
...
--
C23BurstCount = 10			-- Note that most Canon DSLRs can't take more than 13-14 RAW images
								-- in a burst before the buffer is full, and they slow to ~1 image/second.
C2BurstStartOffset = 6
C2BurstTime = 10
...
-- exposures.
--
DoRing = 0		-- Are we going to try for a burst for the diamond ring?
...
TotalityMaxShutterSpeed = 2 -- (MaxShutterSpeed is the *slowest*, longest speed used.)
TotalityExpStep = 1
...
MaxOffset = (10) 		-- How long before max eclipse to start these exposures.  You'll have to test
	...
	then	-- Single exposure
		...
		then
			...
			then
				...
				msleep(ShutterShockDelayMS)			-- Boyang Liu 20190308
